...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  _incrementCounter() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    setState(() {
      cartItem = (prefs.getInt('cartItem') ?? 0) + 1;
      prefs.setInt('cartItem', cartItem);
    });
  }
                ...
                Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      itemInfo(),
                      SizedBox(height: 10),
                      itemActions(product: widget.product),
                      SizedBox(height: 20),
                    ],
                  ),
                ),
  ...
  Widget colorPicker(Color color) {
    return Container(
      ...
      height: 24,
      width: 24,
      child: color == widget.product.productItem[colorIndex].color
          ? Icon(Icons.check)
          : Container(),
      decoration: BoxDecoration(
        color: color,
  ...
  SizedBox buildOutlineButton({IconData icon, Function press}) {
    return SizedBox(
      ...
      child: OutlineButton(
        ...
        borderSide: BorderSide(color: widget.product.color, width: 2),
        shape: RoundedRectangleBorder(
